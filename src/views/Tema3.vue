  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 3
      h1 Identificación del cargo
  
    .row.mt-5.justify-content
      .col-7.col-lg-3
        figure
        ...
        .col-lg-10
          ImagenInfografica.color-acento-botones.mb-5(data-aos="zoom-in")
            template(v-slot:imagen)
              figure
                img(src='@/assets/curso/temas/Tema3/Imagen2.png', alt=' diversos decretos, resoluciones o leyes que posibilitan la seguridad y la salud del trabajador')

            .tarjeta.p-3.tarjetaspuntos(x="10%" y="46%" numero="")
              .row.justify-content-center.align-items-center       
                .col-lg-13
                  h4.mb-2 Nivel jerárquico y dependencia del área
                  p El nivel jerárquico representa un orden de las personas o las actividades que devela la dependencia y la subordinación entre sí. Los tipos de niveles jerárquicos dentro de la empresa son: nivel directivo o superior, nivel táctico o medio, nivel operativo o inferior. Los niveles jerárquicos están representados por medio de organigramas, la cantidad de niveles se generan de acuerdo con la organización. 
 
            .tarjeta.p-3.tarjetaspuntos(x="38%" y="51%" numero="")
              .row.justify-content-center.align-items-center       
                .col-lg-13          
                  h4.mb-2 Responsabilidades del cargo 
                  p.mb-0 Compromisos y obligaciones que debe cumplir la persona que está ocupando un puesto de trabajo. Para esto se debe conocer a profundidad cuáles son las tareas específicas, funciones que desempeña el empleado que ocupa ese cargo, describiéndolas una a una.
            
            .tarjeta.p-3.tarjetaspuntos(x="66%" y="44%" numero="")
              .row.justify-content-center.align-items-center       
                .col-lg-13          
                  h4.mb-2 Relación con otros cargos
                  p Son la herramienta técnica con la cual se debe realizar la ordenación de los empleados, de acuerdo con las necesidades, los requisitos y las características que se requieran para el desempeño de cada puesto de trabajo. 
            
            .tarjeta.p-3.tarjetaspuntos(x="28%" y="32%" numero="")
              .row.justify-content-center.align-items-center       
                .col-lg-13          
                  h4.mb-2 Denominación del cargo 
                  p El objetivo de realizar la denominación del cargo es conocer qué debe hacer, cómo lo debe hacer y para qué debe ocupar un puesto de trabajo.

            .tarjeta.p-3.tarjetaspuntos(x="22%" y="52%" numero="")
              .row.justify-content-center.align-items-center       
                .col-lg-13          
                  h4.mb-2 Objetivos del cargo 
                  p Uno de los objetivos más relevantes en la descripción de un puesto de trabajo, es identificar las principales tareas a realizar por parte del empleado y verificar si cumple con las expectativas del cargo. Esto determina las decisiones del nivel de jerarquía, salario, ascenso y responsabilidades futuras del trabajo a desempeñar.
          
          .cajon.color-acento-contenido.p-4
            p Teniendo en cuenta lo anterior, la identificación de los cargos se puede definir como una herramienta dentro de los diferentes aspectos de los puestos de trabajo en la organización. Allí se deben tener claros cuáles son los deberes y las responsabilidades de un cargo, esto brinda una descripción en cada área que tiene la empresa y por ende, donde está ubicada dentro de la estructura organizativa de la compañía. 

    p.mt-5 El perfil del cargo permite definir las actividades, tareas o funciones y los resultados esperados de ese puesto de trabajo dentro de las jerarquías que se establecen en la empresa.  Otro elemento fundamental dentro de la identificación de los cargos es el análisis y la descripción de los puestos de trabajo, ya que este es una parte importante para lograr el adecuado desempeño de los ocupantes de los cargos dentro de las compañías. Esto ayuda a que no se asignen personas que no tienen las competencias adecuadas para ocupar los puestos de trabajo, ni para desempeñar las tareas y funciones asignadas. Por lo tanto, la correcta identificación y asignación de cargos permite un mejor desempeño del personal para aplicar el conocimiento en las funciones y lograr con éxito los resultados que se esperan en cada área. De esta forma se aporta a la productividad de la empresa, al mejoramiento del ambiente laboral y por ende a los beneficios para todos sus integrantes. 

    .row.justify-content-start.align-items-center.mb-2.mt-4         
      .col-lg-5
        .bgp.p-1
          h3.mb-0 Metodología para clasificación de cargos
